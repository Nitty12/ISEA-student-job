...
const uint8_t GPDMA_LUTPerBurst[] = {
	GPDMA_BSIZE_1,					// SSP0 Tx (for 16 bit data to DAC AD5541A)
	GPDMA_BSIZE_1,					// SSP0 Rx (for 16 bit data to DAC AD5541A)
	//GPDMA_BSIZE_4,					// SSP0 Tx
	//GPDMA_BSIZE_4,					// SSP0 Rx
	GPDMA_BSIZE_4,					// SSP1 Tx
	GPDMA_BSIZE_4,					// SSP1 Rx
...
const uint8_t GPDMA_LUTPerWid[] = {
	GPDMA_WIDTH_HALFWORD,				// SSP0 Tx (for 16 bit data to DAC AD5541A)
	GPDMA_WIDTH_HALFWORD,				// SSP0 Rx (for 16 bit data to DAC AD5541A)
	//GPDMA_WIDTH_BYTE,					// SSP0 Tx
	//GPDMA_WIDTH_BYTE,					// SSP0 Rx
	GPDMA_WIDTH_BYTE,					// SSP1 Tx
	GPDMA_WIDTH_BYTE,					// SSP1 Rx
